...
<div :class="wrapClasses" style="touch-action: none;">
  <slot name="scrollbar">
    <div style="position: absolute;background: #001529;right: 0;width: 18px;height: calc(100vh - 70px);"></div>
  </slot>
  <div :class="scrollContainerClasses" :style="height" @scroll="handleScroll" @wheel="onWheel" @touchstart="onPointerDown" ref="scrollContainer">
